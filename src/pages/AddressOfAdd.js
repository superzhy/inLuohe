...
export default class AddressOfAdd extends Component {
    ...
    changeStatus() {
        ...
        const {name, phone, address,city} = this.state
    ...
    _submit(){
        ...
        fetchRequest('user/address/create','POST',params).then((res)=>{
            console.log(res);
        ...
        return (
            <SafeAreaView>
                ...
                {/*>*/}
                    {/*<Text>设为默认</Text>*/}
                    {/*{*/}
                        {/*this.state.default ? <Icon name='ios-checkmark-circle' size={25} color='#FF5C60'/>*/}
                ...
                {/*按钮*/}
                {
                    this.state.btnStatus ? <TouchableOpacity
                        ...
                        <View
                            style={[styles.submitBtn, {backgroundColor: '#d2d2d2'}]}
                            activeOpacity={0.6}
                        >
                            <Text style={{color: '#999'}}>保存</Text>
                        </View>
